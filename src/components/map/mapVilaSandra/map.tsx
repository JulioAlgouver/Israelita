...
//IMAGES
import imgIgreja from '../../../images/vilaSandra_fachada.jpg';
    ...
    <div id='main_contato'>
      ...
      <div className='contatos'>
        ...
        <div className='btn_facebook'>
          <button>
            <a href='https://www.facebook.com/assembleiadedeusvilasandraemcuritiba' target='_blank' className='linkButton'>
              Facebook
            </a>
          </button>
        </div>
